...
def creat_rack_osm_wss_link_with_id(topo_object, start_rack_num, end_rack_num):
	...
	rack_link_id = f'{start_rack_num}_{end_rack_num}_{up_wss_in_port_id}_{start_rack_up_wss_port_id}_{slot_plan}'
	return rack_link_id, rack_link
...
def release_rack_osm_wss_link(topo_object, rack_link_id):
	...
	if not osm_link.wss_link and not osm_link.wss_switch_link and not osm_link.mid_link:
